...
// 添加歌曲
Route::post('/admin/songSheet/addsd','admin/SongSheet/addsd');
// 编辑歌单
...
Route::get('/admin/User/:id','admin/User/index');

// 编辑单曲
Route::get('/admin/song/:id','admin/Song/index');


// 更新音乐网站COOKIE
Route::get('/api/cookie','api/Index/reset_cookie');
// 获取播放器颜色
Route::get('/css','api/Index/css');
// 获取播放器接口
