...
class Random
{
     ...
     * @return string
     */
    public static function alnum($len = 3)
    {
     ...
     * @return string
     */
    public static function alpha($len = 3)
    {
     ...
     * @return string
     */
    public static function numeric($len = 2)
    {
     ...
     * @return string
     */
    public static function nozero($len = 2)
    {
     ...
     * @return string
     */
    public static function build($type = 'alnum', $len = 4)
    {
        switch ($type)
        {
            case 'alpha':
    ...
    public static function uuid()
    {
        return str_replace('-','',sprintf(
                ...
                '%04x-%04x-%04x-%04x', mt_rand(0, 0xffff), mt_rand(0, 0xffff), mt_rand(0, 0xffff), mt_rand(0, 0x0fff) | 0x4000, mt_rand(0, 0x3fff) | 0x8000, mt_rand(0, 0xffff), mt_rand(0, 0xffff), mt_rand(0, 0xffff)
        ));
    }
